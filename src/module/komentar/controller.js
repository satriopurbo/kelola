...
export class Controller{
    ...
    static async register(req,res){
        ...
        try {
             let[hasil,created]=await komentar.findOrCreate({where:{username},defaults:{id:nanoid(14),password:hashPassword(password),username,role,nama_user}})
             if (!created) {
    ...
    static async update(req,res){
        ...
        let data = await komentar.update({role,nama_user},{where:{id}})
